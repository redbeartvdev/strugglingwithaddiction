      ...
      <section className="legal-body">
        <div className="container">
          <div className="legal-content">
            ...
            <p>
              Struggling With Addiction ("we," "our," or "us") is committed to protecting your privacy.
              This Privacy Policy explains how we collect, use, disclose, and safeguard your information
              when you visit our website or use our services. Please read this policy carefully. If you
            ...
            <ul>
              ...
              <li><strong>Usage data</strong> — pages visited, time spent on pages, links clicked, browser type, and IP address, collected automatically via analytics tools.</li>
              <li><strong>Communications</strong> — any messages you send us through our contact forms or email.</li>
            </ul>
            <p>
              We do not collect sensitive health information unless you voluntarily provide it in a
              message to us. We never require you to disclose personal health details to access our
              free resources.
            </p>
            ...
            <ul>
              ...
              <li>Send you newsletters and recovery resources you have opted into.</li>
            ...
            <p>
              ...
              analyze traffic, and understand user behavior. You may disable cookies through your
              browser settings; however, some features of the site may not function properly without
              them.
            </p>
            <p>
              We may use third-party analytics services (such as Google Analytics) that set their
              own cookies. These services are governed by their own privacy policies.
            </p>

            <h2>5. Third-Party Services</h2>
            <p>
              Our website may contain links to third-party websites, treatment centers, or resources.
            ...
            <p>
              ...
              this policy or as required by law. Newsletter subscriber data is retained until you
              unsubscribe. You may request deletion of your data at any time by contacting us.
            </p>
