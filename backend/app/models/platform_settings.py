...
class PlatformStripeSettings(Base, TimestampMixin):
    ...
    test_secret_key: Mapped[str | None] = mapped_column(Text, nullable=True)
    test_webhook_secret: Mapped[str | None] = mapped_column(Text, nullable=True)
    test_publishable_key: Mapped[str | None] = mapped_column(String(255), nullable=True)
    test_price_monthly: Mapped[str | None] = mapped_column(String(255), nullable=True)
    test_price_yearly: Mapped[str | None] = mapped_column(String(255), nullable=True)
    test_price_verified_badge: Mapped[str | None] = mapped_column(String(255), nullable=True)
    test_price_featured_placement: Mapped[str | None] = mapped_column(String(255), nullable=True)
