...
class RehabCenter(Base, TimestampMixin):
    ...
    intake1: Mapped[str | None] = mapped_column(String(80), nullable=True)
    intake2: Mapped[str | None] = mapped_column(String(80), nullable=True)
    intake1a: Mapped[str | None] = mapped_column(String(80), nullable=True)
    intake2a: Mapped[str | None] = mapped_column(String(80), nullable=True)
    ...
    inquiry_form_enabled: Mapped[bool] = mapped_column(Boolean, default=True)
    ...
    service_codes: Mapped[list[str] | None] = mapped_column(ARRAY(String), default=list)
